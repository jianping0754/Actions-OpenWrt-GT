...
# 添加插件包
echo 'src-git https://github.com/fw876/helloworld' >>feeds.conf.default
echo 'src-git passwall https://github.com/281677160/openwrt-passwall.git' >>feeds.conf.default
