...
# 添加插件包
echo 'src-git helloworld https://github.com/281677160/helloworld' >>feeds.conf.default
echo 'src-git passwall https://github.com/281677160/openwrt-passwall' >>feeds.conf.default
