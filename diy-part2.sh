...
sed -i "/uci commit network/i\uci set network.lan.dns='192.168.31.101 202.96.128.166'" $ZZZ        # DNS(多个DNS要用空格分开)
...
sed -i 's/PATCHVER:=5.10/PATCHVER:=5.15/g' target/linux/x86/Makefile                               # 修改内核为5.15
